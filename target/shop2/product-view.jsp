...
<div id="position" class="wrap">
	您现在的位置：<a href="indexSelect">跳蚤市场-商城</a> &gt; <a href="selectProductList">商品分类</a> &gt; ${title }
</div>
	...
	<div id="product" class="main">
		...
		<div id="mag"><img id="magnifierImg" /></div>
			<div class="buy">
				...
				<div class="button"><input type="button" name="button" value="" onclick="shopAdd(${p.EP_ID})" />
					<a href="javascript:shopAdd2(${p.EP_ID})">放入购物车</a></div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="introduce">
