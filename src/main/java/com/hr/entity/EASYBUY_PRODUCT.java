...
public class EASYBUY_PRODUCT implements Serializable {
	private int EP_ID;//物品
	private String EP_NAME;//物品名称
	private String EP_DESCRIPTION;//物品描述
	private int EP_PRICE;//物品价格
	private int EP_STOCK;//库存
	private int EPC_ID;//物品类别id
	private int EPC_CHILD_ID;
	private String EP_FILE_NAME;//物品照片
