...
public class EASYBUY_COMMENT implements Serializable{
	private int EC_ID;
	private String EC_CONTENT;//留言
	private String EC_CREATE_TIME;//留言日期
	private String EC_REPLY;//留言答复
	private String EC_REPLY_TIME;//留言答复日期
	private String EC_NICK_NAME;//留言用户名称
